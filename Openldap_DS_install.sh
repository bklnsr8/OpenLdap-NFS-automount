...
# edit the /usr/share/migrationtools/migrate_common.ph
sed -i 's/$DEFAULT_MAIL_DOMAIN.*/$DEFAULT_MAIL_DOMAIN = "bkln.com";/' /usr/share/migrationtools/migrate_common.ph

sed -i 's/$DEFAULT_BASE.*/$DEFAULT_BASE = "dc=example,dc=com";/' /usr/share/migrationtools/migrate_common.ph
